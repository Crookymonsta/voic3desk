...
const demoLines = [
  {
    ...
    text: "Goeiemiddag, u spreekt met de AI-antwoordservice en afsprakenplanner van Kapsalon Geknipt. Ik kan een terugbelverzoek voor u aanmaken of samen met u kijken naar een geschikte datum voor een afspraak. Waarmee kan ik u van dienst zijn?",
    status: "AI neemt op",
    audio: "assets/audio/line-1.m4a.mp3",
  },
  {
    speaker: "Klant",
    text: "Hoi, goedemiddag. Mijn naam is Anouk van de Wal. Ik wil graag een afspraak maken op 20 juni, vlak voordat ik op vakantie ga. Hebben jullie rond 15:30 uur nog plek?",
    status: "Klant vraagt 15:30",
    audio: "assets/audio/line-2.m4a.mp3",
  },
  {
    speaker: "Voic3Desk AI",
    text: "Ik zal even voor u kijken. Helaas hebben wij om 15:30 uur geen plek meer. Ik ga kijken wat ik voor u kan doen. Ik heb wel plek voor u om 14:00 uur. Schikt dat voor u?",
    status: "Alternatief voorstellen",
    effect: "busy",
    audio: "assets/audio/line-3.m4a.mp3",
  },
  {
    speaker: "Klant",
    text: "Ja hoor, dat schikt.",
    status: "Alternatief akkoord",
    audio: "assets/audio/line-4.m4a.mp3",
  },
  {
    speaker: "Voic3Desk AI",
    text: "Oh wauw, wat goed. Prima, dan zet ik 20 juni om 14:00 uur voor u klaar als voorstel. Mag ik nog kort vragen waarvoor u precies wilt langskomen? Gaat het alleen om een knipbeurt, of wilt u bijvoorbeeld ook uw haar laten verven of behandelen? Heeft u een voorkeur voor een bepaalde kapper? Dan noteer ik dat er meteen bij.",
  ...
  {
    speaker: "Klant",
    text: "Ik wil graag mijn puntjes laten bijknippen en mijn haar laten verven. Mijn voorkeur gaat eigenlijk uit naar Johan, maar als dat niet lukt, mag het ook iemand anders zijn hoor.",
    status: "Dienst en voorkeur",
    audio: "assets/audio/line-6.m4a.mp3",
  },
  {
    speaker: "Voic3Desk AI",
    text: "Helemaal goed, ik noteer: puntjes bijknippen en haar verven. Ook noteer ik dat uw voorkeur uitgaat naar Johan, maar dat iemand anders ook akkoord is als Johan niet beschikbaar is. Bedankt voor uw reservering. Om de reservering compleet te maken, hebben wij nog uw telefoonnummer nodig. Dan kunnen wij u per sms laten weten wanneer de afspraak definitief is bevestigd.",
...
function resetDemo() {
  ...
  transcript.textContent = "Klik op Start demo om het gesprek van Kapsalon Geknipt te starten.";
  updateVoiceState();
