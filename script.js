...
const demoLines = [
  ...
  },
  {
    ...
    text: "AI maakt het voorstel compleet, gebruikt caller ID als dat kan en vraagt alleen een telefoonnummer als het nummer niet zichtbaar is.",
    status: "Caller ID gecontroleerd",
    effect: "mail",
