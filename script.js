...
const demoLines = [
  {
    speaker: "Klant",
    text: "De klant belt met een afspraakverzoek.",
    status: "Beller vraagt",
    audio: "assets/audio/line-1.m4a.mp3",
  },
  {
    speaker: "Voic3Desk AI",
    text: "Voic3Desk neemt op, vraagt rustig door en controleert de beschikbaarheid.",
    status: "Agenda check",
    effect: "busy",
  ...
  {
    speaker: "Klant",
    text: "De klant kiest een passend alternatief.",
    status: "Alternatief gekozen",
    audio: "assets/audio/line-3.m4a.mp3",
  },
  {
    speaker: "Voic3Desk AI",
    text: "De AI bevestigt dat dit alleen als afspraakoptie wordt klaargezet.",
  ...
  {
    speaker: "Voic3Desk AI",
    text: "De AI verzamelt de gegevens die de ondernemer nodig heeft om snel te beslissen.",
    status: "Gegevens verzamelen",
    audio: "assets/audio/line-5.m4a.mp3",
  },
  {
    speaker: "Klant",
    text: "De klant geeft de ontbrekende gegevens door.",
    status: "Klantgegevens",
    audio: "assets/audio/line-6.m4a.mp3",
  },
  {
    speaker: "Voic3Desk AI",
    text: "Voic3Desk zet het complete voorstel klaar voor de ondernemer.",
  ...
  {
    speaker: "Voic3Desk AI",
    text: "De ondernemer houdt controle: bevestigen, afwijzen of terugbellen.",
    status: "Wacht op akkoord",
    effect: "mail",
    audio: "assets/audio/line-8.m4a.mp3",
  },
];
